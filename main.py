...
def addTask():
    ...
    if task:
        with open("data/tasklist.txt","a") as taskfile:
            taskfile.write(f"\n{task}")
...
def deleteTask():
    ...
    if task in task_list:
        ...
        with open("data/tasklist.txt","w") as taskfile:
...
def openTaskFile():
    try:
        global task_list
        with open("data/tasklist.txt","r") as taskfile:
